                            ...
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range visitor-cl">
                                        <a class="block text-center" href="rejected-birth-application.php"><strong style="color:#03a9f4">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
...
?><div class="col-lg-4">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range visitor-cl">
                                        <a class="block text-center" href="all-birth-application.php"><strong style="color:#03a9f4">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                            ...
                            <div class="income-dashone-total orders-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <div class="income-range">
                                        ...
                                        <a class="block text-center" href="registered-users.php"><strong style="color:#03a9f4">View Detail</strong></a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
