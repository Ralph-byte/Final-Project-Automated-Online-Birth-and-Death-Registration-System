...
$sql="insert into tblapplication(UserID,ApplicationID,DateofBirth,Gender,FullName,PlaceofBirth,NameofFather,NameOfMother,PermanentAdd,PostalAdd,MobileNumber,Email)values(:uid,:appnumber,:dob,:gender,:fname,:pob,:fathername,:mname,:padd,:postaladd,:mobnumber,:email)";
