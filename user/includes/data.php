...
<head>
    ...
    <title>User Chart || Automated Birth & Death online Registration System </title>
    <style>
        .chartbox{
            padding-left: 0;
            padding-right: 0;
...
<div style="display: flex; justify-content: center;">
  <div style="margin-right:100px; margin-left: 80px; margin-top:20px;" class="col-lg-12 mg-b-30 chartbox">
...
labels: tmDate,
      datasets: [{
        label: 'User of Birth & Death Registration Analytics of every month.',
        data: [12, 19, 3, 5, 2, 3],
        backgroundColor: [
            'rgba(255, 99, 132, 0.2)',
            'rgba(255, 159, 64, 0.2)',
